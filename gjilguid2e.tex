...
Geophysical Journal International encourages authors to prepare their papers using \LaTeX.
...
For general style issues, authors are referred to the author guidelines found on the \href{https://academic.oup.com/gji/pages/General_Instructions}{\textcolor{blue}{\underline{journal website}}}. Authors
...
journal web-site  at
\href{https://academic.oup.com/gji}{\textcolor{blue}{\underline{https://academic.oup.com/gji}}} under {\em Author
Guidelines}.
...
For the purpose of refereeing, authors are requested to submit their papers to GJI in single column, double-spaced `Referee format' (\verb"\documentclass[referee]")
...
\chemical{Fe_{2}^{2+}Cr_{2}O_{4}}.\vspace*{-5pt}
...
three authors at the first citation, and thereafter, use et al.\vspace*{-5pt}
...
the American Geophysical Union Latex macros\pagebreak
...
\end{references}
\end{verbatim}
produces the reference list. Article DOIs do not need to be included in the reference list unless no other means of identifying the article is available; if you wish to include a DOI see the final example in the reference list at the end of this template. If you wish to include a DOI in your .bib file use the format \verb"doi = {https://doi.org/10.1234/example.doi}".
\begin{references}
 \reference
Azimi, Sh.A., Kalinin, A.Y., Kalinin, V.B.,
\& Pivovarov, B.L., 1968.
